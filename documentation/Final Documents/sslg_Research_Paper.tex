...
\newcommand{\TeamMemberAemail}{\texttt{kushagra.2400231101@vcet.edu.in}}
\newcommand{\TeamMemberBemail}{\texttt{afroz.2400181201@vcet.edu.in}}
\newcommand{\TeamMemberCemail}{\texttt{sakshi.2400201209@vcet.edu.in}}
\newcommand{\TeamMemberDemail}{\texttt{ramzan.2400251108@vcet.edu.in}}
\newcommand{\GuideNameemail}{\texttt{shaista.khan@vcet.edu.in}}
...
\author{%
  \parbox{\textwidth}{\centering
    ...
    \begin{tabular}{@{}>{\centering\arraybackslash}p{0.48\textwidth}@{\hfill}
      ...
      \TeamMemberAemail & \TeamMemberBemail\\[0.5cm]
      {\large\bfseries\TeamMemberC} & {\large\bfseries\TeamMemberD}\\
      \DeptName & \DeptName\\ \InstituteName & \InstituteName\\
      \TeamMemberCemail & \TeamMemberDemail\\
    \end{tabular}
  }%
}
% ══════════════════════════════════════════════════════════════════════════════
